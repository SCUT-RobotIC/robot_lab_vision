...
class RCVisionTeacherEnvCfg(LocomotionVelocityTeacherEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.robot = RC_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        self.scene.height_scanner.prim_path = "{ENV_REGEX_NS}/Robot/" + self.base_link_name
        self.scene.height_scanner_base.prim_path = "{ENV_REGEX_NS}/Robot/" + self.base_link_name
        self.scene.terrain.terrain_generator = STAIR_SLOPE_CFG
        # ------------------------------Actions------------------------------
        # reduce action scale
       ...
       # ------------------------------Observations------------------------------
        ...
        self.observations.policy.feet_friction.params["asset_cfg"].body_names = self.foot_link_name
        ...
        # ------------------------------Rewards------------------------------
        # General
        self.rewards.is_terminated.weight = -100#设定为负值则惩罚失败
